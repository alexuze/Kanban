...
namespace IntroSE.Kanban.Backend.ServiceLayer
    {
        ...
        public class Service : IService
        {
            ...
            {
                 _BoardService.loadData();
                return _UserService.LoadData(_BoardService.BoardController);
            }
            ...
            {
              _BoardService.BoardController.clear();
                return _UserService.DeleteAll();
            }
        ...
        public Response Register(string email, string password, string nickname)
            {
                return _UserService.Register(email, password, nickname, _BoardService.BoardController,null);
            }
            /// <summary>
            /// Registers a new user
            /// </summary>
            ...
            /// <param name="password">The password of the user to register</param>
            /// <param name="nickname">The nickname of the user to register</param>
            ///  <param name="emailHost">The email of the board we add the user to</param>
            /// <returns>A response object. The response should contain a error message in case of an error<returns>
            public Response Register(string email, string password, string nickname, string emailHost)
            {
                return _UserService.Register(email, password, nickname, _BoardService.BoardController, emailHost);
            }
          ...
          /// <returns>A response object. The response should contain a error message in case of an error</returns>
            ...
            {
              return _BoardService.AssignTask(email, columnOrdinal, taskId, emailAssignee);
          ...
          /// <returns>A response object. The response should contain a error message in case of an error</returns>
            ...
            {
              return _BoardService.DeleteTask(email, columnOrdinal, taskId);
          ...
          /// <returns>A response object. The response should contain a error message in case of an error</returns>
            ...
            {
                return _BoardService.ChangeColumnName(email, columnOrdinal, newName);
            }
        }
    }
